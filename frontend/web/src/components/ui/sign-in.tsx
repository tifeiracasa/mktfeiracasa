    ...
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              {state.error && (
                <div className="animate-element animate-delay-550 p-3 bg-red-50 border border-red-200 rounded-lg text-red-600 text-sm">
                  {state.error}
                </div>
              )}
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              New to our platform? {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
      ...
      {heroImageSrc && (
        <section className="hidden md:block flex-1 relative p-4">
          <div 
            className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1642615835477-d303d7dc9ee9?w=2160&q=80')]"
          ></div>
